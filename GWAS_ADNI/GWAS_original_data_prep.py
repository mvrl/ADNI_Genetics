...
root_path = '/mnt/gpfs2_16m/pscratch/nja224_uksr/SKH259/LinLab/ADNI_Genetics/Genomics/data/GWAS/'
...
my_merge.to_csv(analysis_path+'/my_MERGE.csv')
...
with open(analysis_path+'/cov_pheno.txt','w') as outfile:
    myfid_iid = ''
    text = header + '\n'
    for s in fid_iid:
...
with open(analysis_path+'/myFID_IIDs.txt','w') as outfile:
