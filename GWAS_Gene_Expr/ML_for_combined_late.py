...
def train_ADNI(groups='CN_AD',features=1000,data_type = 'combined'):
    ...
    results_path = '/home/skh259/LinLab/LinLab/ADNI_Genetics/GWAS_Gene_Expr/results_late/'
    ...
    df_final.to_csv(os.path.join(results_path,'FOR_Late_fusion_'+str(features)+'GWAS12_data_Dx_bl.csv'))

    df_final = pd.read_csv(os.path.join(results_path,'FOR_Late_fusion_'+str(features)+'GWAS12_data_Dx_bl.csv'),na_values=["00"])
    ...
    print("Shape of final GWAS data BEFORE FEATURE SELECTION")
    ...
    print("Shape of final GeneExpr data BEFORE FEATURE SELECTION")
    ...
    plt.legend(loc="best")
    plt.grid(False)
    plt.savefig(os.path.join(results_path,'Grid_search_Using'+'_'+str(features)+'_'+str(data_type)+'_features_for:'+groups+'.png'))
